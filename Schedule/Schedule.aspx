...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lbl_noChosenSchedule" runat="server" Text="ALERT: You have not yet selected a Schedule.  Please select a 'Potential Schedule' from the list below." ForeColor="Red"></asp:Label>
        <br />
        <br />
        <br />
        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:Button ID="btn_createSchedule" runat="server" width="40px" Text="GO" OnClientClick="return confirmCreate();" OnClick="btn_createSchedule_Click" />
                </td>
            </tr>
        </table>
        ...
        <asp:Label ID="lbl_noPotentialSchedule" runat="server" Text="ALERT: There are no Potential Schedules generated.  Please enter a number between 1 and 10 and hit 'Go' above." ForeColor="Red"></asp:Label>
        <br />
        <br />
        <br />
        <a name="preview"></a>
