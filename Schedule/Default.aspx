...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Button style="height:25px; width:200px" ID="btn_manage" runat="server" Text="Manage League" OnClick="btn_manage_Click" />
        <br />
        <br />
        <asp:DropDownList style="height:25px" ID="dd_league" runat="server" Height="25px" OnSelectedIndexChanged="dd_league_SelectedIndexChanged" Width="307px" AutoPostBack="True" DataSourceID="SqlDataSource_League" DataTextField="league_name" DataValueField="league_id"></asp:DropDownList> 
